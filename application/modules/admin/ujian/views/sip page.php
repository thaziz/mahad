							...
							<div class="tab-content">
								...
								<div class="content-holder">
									...
									<?php foreach ($pilihan as $key => $v): ?>
										...
										?>
								<div class="soal" <?=$yes ?> id="soal-<?=$key?>" data-id="<?=$key ?>" >
													...
													<table class="table" width="100%">
														...
														<tr>
															...
															<td style="width: 0.5em">
																<input type="radio" onchange="setjawaban('pilihan','<?=$v->sd_no?>','<?=$a[1];?>','<?=$key?>')" name="jawaban<?=$v->sd_no;?>" value="<?=$a[1]; ?>" class="ds">
															</td>
															<td colspan="1"><?=$a[0]?></td>
														</tr>
														<tr> 
															<td></td>
															<td>b.</td>
															<td style="width: 0.5em"><input class="ds" type="radio" name="jawaban<?=$v->sd_no?>" value="<?=$b[1]?>" onchange="setjawaban('pilihan','<?=$v->sd_no?>','<?=$b[1];?>','<?=$key?>')" ></td>
															<td colspan="1"><?=$b[0];?></td>
														</tr>
														<tr>
															<td></td>
															<td>c.</td>
															<td style="width: 0.5em"><input type="radio" name="jawaban<?=$v->sd_no?>" value="<?=$c[1] ?>" class="ds" onchange="setjawaban('pilihan','<?=$v->sd_no?>','<?=$c[1];?>','<?=$key?>')" ></td>
															<td colspan="1"><?=$c[0] ?></td>
														</tr>
														<tr> 
															<td></td><td>d.</td>
															<td style="width: 0.5em"><input type="radio" name="jawaban<?=$v->sd_no?>" value="<?=$d[1] ?>" class="ds" onchange="setjawaban('pilihan','<?=$v->sd_no?>','<?=$d[1];?>','<?=$key ?>')"></td>
															<td colspan="1"><?=$d[0] ?></td>
														</tr>
													</table>
												</div>												
								...
								<div class="soal" <?=$yes ?> id="soal-<?=$key?>" data-id="<?=$key ?>" >
										...
										<div class="end" data-id="<?=count($pilihan)+1 ?>">
