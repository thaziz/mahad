								...
								<div class="content-holder" style="border-style: outset;">
											...
											<div class="soal" <?=$yes ?> id="soal-<?=$idx?>" data-id="<?=$idx ?>" >
												...
												<table class="table" width="100%">
													...
													<tr>
														...
														<td style="width: 0.5em">
															<input <?=$ja?> type="radio" onchange="setjawaban('pilihan','<?=$v->sd_no?>','<?=$a[1];?>','<?=$idx?>')" name="jawaban<?=$v->sd_no;?>" value="<?=$a[1]; ?>" class="ds">
														</td>
														<td colspan="1"><?=$a[0]?></td>
													</tr>
													<tr> 
														...
														<td>b.</td>
														<td style="width: 0.5em">
															<input <?=$jb ?> class="ds" type="radio" name="jawaban<?=$v->sd_no?>" value="<?=$b[1]?>" onchange="setjawaban('pilihan','<?=$v->sd_no?>','<?=$b[1];?>','<?=$idx?>')" ></td>
														<td colspan="1"><?=$b[0];?></td>
													</tr>
													<tr>
														<td></td>
														<td>c.</td>
														<td style="width: 0.5em">
															<input <?=$jc ?> type="radio" name="jawaban<?=$v->sd_no?>" value="<?=$c[1] ?>" class="ds" onchange="setjawaban('pilihan','<?=$v->sd_no?>','<?=$c[1];?>','<?=$idx?>')" ></td>
														<td colspan="1"><?=$c[0] ?></td>
													</tr>
													<tr> 
														<td></td><td>d.</td>
														<td style="width: 0.5em">
															<input <?=$jd ?> type="radio" name="jawaban<?=$v->sd_no?>" value="<?=$d[1] ?>" class="ds" onchange="setjawaban('pilihan','<?=$v->sd_no?>','<?=$d[1];?>','<?=$idx ?>')"></td>
														<td colspan="1"><?=$d[0] ?></td>
													</tr>
												</table>
											</div>
									...
									<?php if(count($bs)>0): ?>
											...
											<div class="soal" <?=$yes ?> id="soal-<?=$idx?>" data-id="<?=$idx ?>" >
												<table class="table" width="100%">
													...
													<tr>
														...
														<td style="width: 0.5em">
															<input <?=$ja?> onchange="setjawaban('bs','<?=$v->sd_no?>','<?=$a[1];?>','<?=$idx?>')" type="radio" name="jawaban_bs<?=$v->sd_no;?>" value="<?=$a[1]?>" class="ds"></td>
															<td colspan="1"><?=$a[0];?></td>
															<tr> 
																<td></td><td></td>
																<td style="width: 0.5em">
																	<input <?=$jb?> onchange="setjawaban('bs','<?=$v->sd_no?>','<?=$b[1];?>','<?=$idx?>')"  type="radio" name="jawaban_bs<?=$v->sd_no?>" value="<?=$b[1]?>" class="ds"></td>
																<td colspan="1"><?=$b[0];?></td>
															</tr></tr>
										...
										<div class="end" data-id="<?=$idx?>">
											...
											<button type="button" class="btn btn-xs btn-primary edit-previous">Simpan</button>
										</div>
