					...
					<form class="form-horizontal" method="post" id="admin_form">
				        <div class="box-body">
				          	...
				          	<div class="form-group">
					            ...
					            <div class="col-sm-4">
					              <input type="text" placeholder="NIM" name = "adm_nim" id="adm_nim" class="form-control">
					              <span class="info"></span>
					            </div>
				          	</div>
				          	...
				          	<div class="form-group">
					            ...
					            <div class="col-sm-5">					             
					              <input placeholder="Level" name = "adm_level" id="adm_level" class="form-control" >
					              <span class="info"></span>
					            </div>
				          	</div>
				          	...
				          	<div class="form-group">
					            ...
					            <div class="col-sm-5">					             
					             <input placeholder="Kelas" name = "adm_kelas" id="adm_kelas" class="form-control" >
					              <span class="info"></span>
					            </div>
				          	</div>
