...
class Admin extends MX_Controller {
	...
	public function index(){
		...
		if($_POST && $auth){
	        ...
	        foreach ($list as $admin) {
	            ...
	            $row[] = $admin->adm_name;
	            $row[] = $admin->adm_nim;
	            $row[] = $admin->adm_level.' '.$admin->adm_kelas;
	...
	public function admin_insert(){
		...
		if($_POST && $auth){
            ...
            $this->form_validation->set_rules('adm_level', 'Level', 
            				'required');
            $this->form_validation->set_rules('adm_kelas', 'Kelas', 
            				'required');
            ...
            if ($this->form_validation->run() == false){
            	$data['status'] = false;
            	$data['e']['adm_level'] = form_error('adm_level', '<div class="has-error">', '</div>');
            	$data['e']['adm_kelas'] = form_error('adm_kelas', '<div class="has-error">', '</div>');
	...
	public function admin_edit($id){
		...
		if($_POST && $auth){
            ...
            $check_unique = ($_POST['adm_nim'] != $_POST['adm_nim_old'])?'|is_unique[v_admin.adm_nim]':'';
            $this->form_validation->set_rules('adm_nim', 'NIM', 'required'.$check_unique);
