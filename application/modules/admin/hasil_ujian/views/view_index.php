...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#table_ujian').dataTable({
      ...
      "ajax": {
              "url": "<?php echo base_url('panel/hasil_ujian'); ?>",
              "type": "POST"
          },
      "aaSorting": [[ 1, "desc" ]],
      "searching": true,
...
console.log(full)
          ...
          return ''
              <?php } ?>
              <?php if($rules['e']){?>
              + ''+'<a href=<?=base_url('panel/hasil_ujian/list');?>/' + full[3]
              + ' class="btn btn-info btn-xs btn-col icon-green" '+full[5]+'><i class="fa fa-list"></i> Detail'
              <?php }?>
             /* <?php if($rules['d']){?>
